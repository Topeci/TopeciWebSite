  ...
  return (
      <main className="flex-grow w-full bg-white">
        <div className="container mx-auto px-4 py-16">
          <h1 className="text-4xl font-bold text-center mb-4 font-['Waffle_soft'] text-[#4E6FA7]">
            Restons en contact
          </h1>
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12 font-['Glacial_Indifference'] text-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
              ...
              <p className="text-gray-600 mb-6 font-['Glacial_Indifference']">
                ...
                traitement automatisé, on pourra brancher une route API plus
                tard.
              </p>
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="grid gap-2">
                    <label
                      htmlFor="email"
                      className="font-medium text-[#4E6FA7]"
                    >
                      Email
                    </label>
                    <input
