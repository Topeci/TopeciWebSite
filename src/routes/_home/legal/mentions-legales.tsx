  ...
  return (
    <div className="px-6 py-10 max-w-4xl mx-auto text-gray-800">
      ...
      <p>
        ...
        illustrations, logos, icônes, sons, vidéos, logiciels, bases de données,
        etc.) sont protégés par les dispositions du Code de la propriété
        intellectuelle et demeurent la propriété exclusive de TOPECI ou de ses
        partenaires. Toute reproduction, représentation, modification,
        publication, transmission ou dénaturation totale ou partielle du site ou
        de son contenu, par quelque procédé que ce soit, sans l’autorisation
        expresse de TOPECI, est interdite et pourra donner lieu à des
        poursuites.
      </p>
      ...
      <p>
        ...
        etc.) dans le cadre de ses services. Les traitements réalisés respectent
        la réglementation en vigueur (RGPD – Règlement Général sur la Protection
        des Données).
      </p>
      <ul className="list-disc list-inside">
        ...
        <li>Durée de conservation : limitée et proportionnée aux finalités.</li>
        <li>
      ...
      <p>
        TOPECI met tout en œuvre pour assurer l’exactitude et la mise à jour des
        informations diffusées sur le site. Toutefois, TOPECI ne saurait être
        tenu responsable des erreurs ou omissions, ni des éventuels dommages
        liés à l’utilisation du site ou de ses contenus. Le site peut contenir
        des liens vers d’autres sites internet. TOPECI n’exerce aucun contrôle
        sur ces sites et décline toute responsabilité quant à leurs contenus.
      </p>
